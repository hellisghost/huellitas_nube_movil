...
import { listarRazas, registrarRaza, actualizarRaza, eliminarRaza, buscarRaza, listarrazas } from "../controllers/razas.controller.js";
...
RazasRoutes.get("/listarrazas/:categoriaId", /* validarToken, */ listarrazas);
